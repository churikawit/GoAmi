...
func BindIdData(input string) (data *IdData) {
	data = &IdData{}
	...
	fmt.Printf("BindIdData input: %v\n", input)
	fmt.Printf("BindIdData output: %v\n", data)
	return
}
...
func BindHomeData(input string) (data *HomeData) {
	data = &HomeData{}
	err := json.Unmarshal([]byte(input), &data)
	if err != nil {
	...
	fmt.Printf("BindHomeData input: %v\n", input)
	fmt.Printf("BindHomeData output: %v\n", data)
	return
}